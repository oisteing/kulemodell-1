...
translations = {
    "Nynorsk": {
        ...
        "modell3": "Denne modellen lar deg legge eit antal raude og blå kuler i ei eske, for så å trekkje ut eit visst antal. Dette kan gjentakast fleire gonger med fleire simuleringar.",
        ...
        "gonger før første": "gongar før du fekk den første raude kula",
    ...
    "Bokmål": {
        ...
        "modell3": "Denne modellen lar deg legge røde og blå kuler i ei eske, for så å trekke ut et visst antall. Dette kan gjentas flere ganger med flere simuleringer.",
...
with tab1:
  ...
  raude_i_esken = int(st.number_input(translations[selection]['kor mange raude i eska'], min_value=1, value=1, max_value=kuler_i_esken))
...
with tab2:
  ...
  raude_i_esken2 = int(st.number_input(translations[selection]['kor mange raude i eska'] ,min_value=1, max_value=kuler_i_esken2, key=22))
...
with tab3:
  ...
  kuler_i_esken3 = int(st.number_input(translations[selection]['kor mange kuler i eska'], min_value=1, value=100, key=31))
  raude_i_esken3 = int(st.number_input(translations[selection]['kor mange raude i eska']+f"(max {kuler_i_esken3})",min_value=1, value=5, key=32))
